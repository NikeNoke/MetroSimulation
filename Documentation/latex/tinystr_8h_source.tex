...
\label{tinystr_8h_source}\index{tinystr.h@{tinystr.h}}
...
\DoxyCodeLine{00055\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classTiXmlString}{TiXmlString}}}
\DoxyCodeLine{00056\ \{}
...
\DoxyCodeLine{00066\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ ()\ :\ rep\_(\&nullrep\_)}
\DoxyCodeLine{00067\ \ \ \ \ \{}
\DoxyCodeLine{00068\ \ \ \ \ \}}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00070\ \ \ \ \ \textcolor{comment}{//\ TiXmlString\ copy\ constructor}}
\DoxyCodeLine{00071\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ (\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ copy)\ :\ rep\_(0)}
\DoxyCodeLine{00072\ \ \ \ \ \{}
...
\DoxyCodeLine{00078\ \ \ \ \ TIXML\_EXPLICIT\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ (\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ copy)\ :\ rep\_(0)}
\DoxyCodeLine{00079\ \ \ \ \ \{}
...
\DoxyCodeLine{00085\ \ \ \ \ TIXML\_EXPLICIT\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ (\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ str,\ size\_type\ len)\ :\ rep\_(0)}
\DoxyCodeLine{00086\ \ \ \ \ \{}
...
\DoxyCodeLine{00092\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{\string~TiXmlString}}\ ()}
\DoxyCodeLine{00093\ \ \ \ \ \{}
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ quit();}
\DoxyCodeLine{00095\ \ \ \ \ \}}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00097\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ operator\ =\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ copy)}
\DoxyCodeLine{00098\ \ \ \ \ \{}
\DoxyCodeLine{00099\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ assign(\ copy,\ (size\_type)strlen(copy));}
\DoxyCodeLine{00100\ \ \ \ \ \}}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ operator\ =\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ copy)}
\DoxyCodeLine{00103\ \ \ \ \ \{}
...
\DoxyCodeLine{00109\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ operator\ +=\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ suffix)}
\DoxyCodeLine{00110\ \ \ \ \ \{}
...
\DoxyCodeLine{00115\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ operator\ +=\ (\textcolor{keywordtype}{char}\ single)}
\DoxyCodeLine{00116\ \ \ \ \ \{}
...
\DoxyCodeLine{00121\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ operator\ +=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ suffix)}
\DoxyCodeLine{00122\ \ \ \ \ \{}
...
\DoxyCodeLine{00192\ }
\DoxyCodeLine{00193\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ assign\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str,\ size\_type\ len);}
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00195\ \ \ \ \ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ append\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str,\ size\_type\ len);}
\DoxyCodeLine{00196\ }
\DoxyCodeLine{00197\ \ \ \ \ \textcolor{keywordtype}{void}\ swap\ (\mbox{\hyperlink{classTiXmlString}{TiXmlString}}\&\ other)}
\DoxyCodeLine{00198\ \ \ \ \ \{}
...
\DoxyCodeLine{00253\ }
\DoxyCodeLine{00254\ }
\DoxyCodeLine{00255\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)}
\DoxyCodeLine{00256\ \{}
...
\DoxyCodeLine{00259\ \}}
\DoxyCodeLine{00260\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ <\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)}
\DoxyCodeLine{00261\ \{}
\DoxyCodeLine{00262\ \ \ \ \ \textcolor{keywordflow}{return}\ strcmp(a.c\_str(),\ b.c\_str())\ <\ 0;}
\DoxyCodeLine{00263\ \}}
\DoxyCodeLine{00264\ }
\DoxyCodeLine{00265\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(a\ ==\ b);\ \}}
\DoxyCodeLine{00266\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ >\ \ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ b\ <\ a;\ \}}
\DoxyCodeLine{00267\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ <=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(b\ <\ a);\ \}}
\DoxyCodeLine{00268\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ >=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(a\ <\ b);\ \}}
\DoxyCodeLine{00269\ }
\DoxyCodeLine{00270\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b)\ \{\ \textcolor{keywordflow}{return}\ strcmp(a.c\_str(),\ b)\ ==\ 0;\ \}}
\DoxyCodeLine{00271\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ b\ ==\ a;\ \}}
\DoxyCodeLine{00272\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b)\ \{\ \textcolor{keywordflow}{return}\ !(a\ ==\ b);\ \}}
\DoxyCodeLine{00273\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(b\ ==\ a);\ \}}
\DoxyCodeLine{00274\ }
\DoxyCodeLine{00275\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b);}
\DoxyCodeLine{00276\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b);}
\DoxyCodeLine{00277\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ a,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ b);}
\DoxyCodeLine{00278\ }
\DoxyCodeLine{00279\ }
...
\DoxyCodeLine{00284\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classTiXmlOutStream}{TiXmlOutStream}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}}
\DoxyCodeLine{00285\ \{}
\DoxyCodeLine{00286\ public\ :}
\DoxyCodeLine{00287\ }
\DoxyCodeLine{00288\ \ \ \ \ \textcolor{comment}{//\ TiXmlOutStream\ <<\ operator.}}
\DoxyCodeLine{00289\ \ \ \ \ \mbox{\hyperlink{classTiXmlOutStream}{TiXmlOutStream}}\ \&\ operator\ <<\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classTiXmlString}{TiXmlString}}\ \&\ in)}
\DoxyCodeLine{00290\ \ \ \ \ \{}
...
\DoxyCodeLine{00296\ \ \ \ \ \mbox{\hyperlink{classTiXmlOutStream}{TiXmlOutStream}}\ \&\ operator\ <<\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ in)}
\DoxyCodeLine{00297\ \ \ \ \ \{}
