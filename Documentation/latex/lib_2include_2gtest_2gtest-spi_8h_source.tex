\hypertarget{lib_2include_2gtest_2gtest-spi_8h_source}{}\doxysection{lib/include/gtest/gtest-\/spi.h}
\label{lib_2include_2gtest_2gtest-spi_8h_source}\index{gtest-\/spi.h@{gtest-\/spi.h}}
...
\DoxyCodeLine{00064\ \ \ \textcolor{keyword}{explicit}\ ScopedFakeTestPartResultReporter(TestPartResultArray*\ result);}
\DoxyCodeLine{00065\ }
...
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ TestPartResultArray*\ result);}
\DoxyCodeLine{00069\ }
...
\DoxyCodeLine{00078\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ ReportTestPartResult(\textcolor{keyword}{const}\ TestPartResult\&\ result);}
...
\DoxyCodeLine{00084\ \ \ TestPartResultArray*\ \textcolor{keyword}{const}\ result\_;}
\DoxyCodeLine{00085\ }
...
\DoxyCodeLine{00099\ \ \ SingleFailureChecker(\textcolor{keyword}{const}\ TestPartResultArray*\ results,}
...
\DoxyCodeLine{00104\ \ \ \textcolor{keyword}{const}\ TestPartResultArray*\ \textcolor{keyword}{const}\ results\_;}
