\hypertarget{include_2gtest_2gtest-message_8h_source}{}\doxysection{include/gtest/gtest-\/message.h}
\label{include_2gtest_2gtest-message_8h_source}\index{gtest-\/message.h@{gtest-\/message.h}}
...
\DoxyCodeLine{00085\ \textcolor{keyword}{class\ }GTEST\_API\_\ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\ \{}
...
\DoxyCodeLine{00093\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}();}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \ \ \textcolor{comment}{//\ Copy\ constructor.}}
\DoxyCodeLine{00096\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ msg)\ :\ ss\_(new\ ::std::stringstream)\ \{\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00097\ \ \ \ \ *ss\_\ <<\ msg.GetString();}
\DoxyCodeLine{00098\ \ \ \}}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \ \ \textcolor{comment}{//\ Constructs\ a\ Message\ from\ a\ C-\/string.}}
\DoxyCodeLine{00101\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classtesting_1_1Message}{Message}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str)\ :\ ss\_(new\ ::std::stringstream)\ \{}
...
\DoxyCodeLine{00108\ \ \ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(\textcolor{keyword}{const}\ T\&\ value)\ \{}
...
\DoxyCodeLine{00115\ \ \ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(\textcolor{keyword}{const}\ T\&\ val)\ \{}
...
\DoxyCodeLine{00149\ \ \ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(T*\ \textcolor{keyword}{const}\&\ pointer)\ \{\ \ \textcolor{comment}{//\ NOLINT}}
...
\DoxyCodeLine{00165\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(BasicNarrowIoManip\ val)\ \{}
...
\DoxyCodeLine{00171\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(\textcolor{keywordtype}{bool}\ b)\ \{}
...
\DoxyCodeLine{00177\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(\textcolor{keyword}{const}\ \textcolor{keywordtype}{wchar\_t}*\ wide\_c\_str);}
\DoxyCodeLine{00178\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(\textcolor{keywordtype}{wchar\_t}*\ wide\_c\_str);}
\DoxyCodeLine{00179\ }
...
\DoxyCodeLine{00183\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(const\ ::std::wstring\&\ wstr);}
...
\DoxyCodeLine{00189\ \ \ \mbox{\hyperlink{classtesting_1_1Message}{Message}}\&\ operator\ <<(const\ ::wstring\&\ wstr);}
