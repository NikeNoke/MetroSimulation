\hypertarget{include_2gtest_2internal_2gtest-linked__ptr_8h_source}{}\doxysection{include/gtest/internal/gtest-\/linked\+\_\+ptr.h}
\label{include_2gtest_2internal_2gtest-linked__ptr_8h_source}\index{gtest-\/linked\_ptr.h@{gtest-\/linked\_ptr.h}}
...
\DoxyCodeLine{00110\ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1GTestMutexLock}{MutexLock}}\ lock(\&g\_linked\_ptr\_mutex);}
\DoxyCodeLine{00111\ }
...
\DoxyCodeLine{00122\ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1GTestMutexLock}{MutexLock}}\ lock(\&g\_linked\_ptr\_mutex);}
\DoxyCodeLine{00123\ }
...
\DoxyCodeLine{00125\ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ \textcolor{keyword}{const}*\ p\ =\ next\_;}
...
\DoxyCodeLine{00142\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}(T*\ ptr\ =\ NULL)\ \{\ capture(ptr);\ \}}
...
\DoxyCodeLine{00146\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>\ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<U>}}\ \textcolor{keyword}{const}\&\ ptr)\ \{\ copy(\&ptr);\ \}}
\DoxyCodeLine{00147\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}\ \textcolor{keyword}{const}\&\ ptr)\ \{\ \ \textcolor{comment}{//\ NOLINT}}
...
\DoxyCodeLine{00153\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>\ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}\&\ operator=(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<U>}}\ \textcolor{keyword}{const}\&\ ptr)\ \{}
\DoxyCodeLine{00154\ \ \ \ \ depart();}
\DoxyCodeLine{00155\ \ \ \ \ copy(\&ptr);}
\DoxyCodeLine{00156\ \ \ \ \ \textcolor{keywordflow}{return}\ *\textcolor{keyword}{this};}
\DoxyCodeLine{00157\ \ \ \}}
\DoxyCodeLine{00158\ }
\DoxyCodeLine{00159\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}\&\ operator=(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr}}\ \textcolor{keyword}{const}\&\ ptr)\ \{}
...
\DoxyCodeLine{00179\ \ \ \textcolor{keywordtype}{bool}\ operator==(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<U>}}\ \textcolor{keyword}{const}\&\ ptr)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00183\ \ \ \textcolor{keywordtype}{bool}\ operator!=(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<U>}}\ \textcolor{keyword}{const}\&\ ptr)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00201\ \ \ \}}
\DoxyCodeLine{00202\ }
\DoxyCodeLine{00203\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>\ \textcolor{keywordtype}{void}\ copy(\mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<U>}}\ \textcolor{keyword}{const}*\ ptr)\ \{}
...
\DoxyCodeLine{00213\ \textcolor{keywordtype}{bool}\ operator==(T*\ ptr,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<T>}}\&\ x)\ \{}
