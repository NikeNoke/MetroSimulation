\hypertarget{lib_2include_2gtest_2internal_2gtest-death-test-internal_8h_source}{}\doxysection{lib/include/gtest/internal/gtest-\/death-\/test-\/internal.h}
\label{lib_2include_2gtest_2internal_2gtest-death-test-internal_8h_source}\index{gtest-\/death-\/test-\/internal.h@{gtest-\/death-\/test-\/internal.h}}
...
\DoxyCodeLine{00168\ \ \ \ \ \ \ \ \ "{}death\ test\ statement.\ Exception\ message:\ \%s\(\backslash\)n"{},\ \(\backslash\)}
\DoxyCodeLine{00169\ \ \ \ \ \ \ \ \ ::testing::internal::FormatFileLocation(\_\_FILE\_\_,\ \_\_LINE\_\_).c\_str(),\ \(\backslash\)}
\DoxyCodeLine{00170\ \ \ \ \ \ \ \ \ gtest\_exception.what());\ \(\backslash\)}
\DoxyCodeLine{00171\ \ \ \ \ fflush(stderr);\ \(\backslash\)}
\DoxyCodeLine{00172\ \ \ \ \ death\_test-\/>Abort(::testing::internal::DeathTest::TEST\_THREW\_EXCEPTION);\ \(\backslash\)}
\DoxyCodeLine{00173\ \ \ \}\ catch\ (...)\ \{\ \(\backslash\)}
\DoxyCodeLine{00174\ \ \ \ \ death\_test-\/>Abort(::testing::internal::DeathTest::TEST\_THREW\_EXCEPTION);\ \(\backslash\)}
\DoxyCodeLine{00175\ \ \ \}}
\DoxyCodeLine{00176\ }
...
\DoxyCodeLine{00306\ \ \ \ \ \ \ \ \ \ \ <<\ "{}Statement\ '"{}\ \#statement\ "{}'\ cannot\ be\ verified."{};\ \(\backslash\)}
\DoxyCodeLine{00307\ \ \ \ \ \}\ else\ if\ (::testing::internal::AlwaysFalse())\ \{\ \(\backslash\)}
\DoxyCodeLine{00308\ \ \ \ \ \ \ ::testing::internal::RE::PartialMatch("{}.*"{},\ (regex));\ \(\backslash\)}
\DoxyCodeLine{00309\ \ \ \ \ \ \ GTEST\_SUPPRESS\_UNREACHABLE\_CODE\_WARNING\_BELOW\_(statement);\ \(\backslash\)}
\DoxyCodeLine{00310\ \ \ \ \ \ \ terminator;\ \(\backslash\)}
\DoxyCodeLine{00311\ \ \ \ \ \}\ else\ \(\backslash\)}
\DoxyCodeLine{00312\ \ \ \ \ \ \ ::testing::Message()}
\DoxyCodeLine{00313\ }
