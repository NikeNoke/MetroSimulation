\hypertarget{lib_2include_2gtest_2internal_2gtest-internal_8h_source}{}\doxysection{lib/include/gtest/internal/gtest-\/internal.h}
\label{lib_2include_2gtest_2internal_2gtest-internal_8h_source}\index{gtest-\/internal.h@{gtest-\/internal.h}}
...
\DoxyCodeLine{00160\ \ \ ScopedTrace(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ file,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ Message\&\ message);}
\DoxyCodeLine{00161\ }
...
\DoxyCodeLine{00189\ GTEST\_API\_\ AssertionResult\ EqFailure(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ expected\_expression,}
...
\DoxyCodeLine{00197\ \ \ \ \ \textcolor{keyword}{const}\ AssertionResult\&\ assertion\_result,}
...
\DoxyCodeLine{00232\ \textcolor{keyword}{class\ }FloatingPoint\ \{}
...
\DoxyCodeLine{00236\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ TypeWithSize<\textcolor{keyword}{sizeof}(RawType)>::UInt\ Bits;}
\DoxyCodeLine{00237\ }
...
\DoxyCodeLine{00280\ \ \ \textcolor{keyword}{explicit}\ FloatingPoint(\textcolor{keyword}{const}\ RawType\&\ x)\ \{\ u\_.value\_\ =\ x;\ \}}
\DoxyCodeLine{00281\ }
...
\DoxyCodeLine{00288\ \ \ \ \ FloatingPoint\ fp(0);}
...
\DoxyCodeLine{00402\ \textcolor{keyword}{class\ }TypeIdHelper\ \{}
...
\DoxyCodeLine{00434\ \textcolor{keyword}{class\ }TestFactoryBase\ \{}
...
\DoxyCodeLine{00452\ \textcolor{keyword}{class\ }TestFactoryImpl\ :\ \textcolor{keyword}{public}\ TestFactoryBase\ \{}
...
\DoxyCodeLine{00499\ \ \ \ \ TestFactoryBase*\ factory);}
\DoxyCodeLine{00500\ }
...
\DoxyCodeLine{00665\ \textcolor{keyword}{struct\ }GTEST\_API\_\ ConstCharPtr\ \{}
...
\DoxyCodeLine{00676\ \textcolor{keyword}{class\ }GTEST\_API\_\ Random\ \{}
...
\DoxyCodeLine{00696\ \textcolor{keyword}{struct\ }CompileAssertTypesEqual;}
\DoxyCodeLine{00697\ }
\DoxyCodeLine{00698\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00699\ \textcolor{keyword}{struct\ }CompileAssertTypesEqual<T,\ T>\ \{}
\DoxyCodeLine{00700\ \};}
\DoxyCodeLine{00701\ }
...
\DoxyCodeLine{00706\ \textcolor{keyword}{struct\ }RemoveReference\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00707\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00708\ \textcolor{keyword}{struct\ }RemoveReference<T\&>\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00709\ }
...
\DoxyCodeLine{00719\ \textcolor{keyword}{struct\ }RemoveConst\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00720\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00721\ \textcolor{keyword}{struct\ }RemoveConst<const\ T>\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00722\ }
...
\DoxyCodeLine{00727\ \textcolor{keyword}{struct\ }RemoveConst<const\ T[N]>\ \{}
...
\DoxyCodeLine{00736\ \textcolor{keyword}{struct\ }RemoveConst<T[N]>\ \{}
...
\DoxyCodeLine{00754\ \textcolor{keyword}{struct\ }AddReference\ \{\ \textcolor{keyword}{typedef}\ T\&\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00755\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00756\ \textcolor{keyword}{struct\ }AddReference<T\&>\ \{\ \textcolor{keyword}{typedef}\ T\&\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00757\ }
...
\DoxyCodeLine{00779\ \textcolor{keyword}{class\ }ImplicitlyConvertible\ \{}
...
\DoxyCodeLine{00832\ \textcolor{keyword}{struct\ }IsAProtocolMessage}
\DoxyCodeLine{00833\ \ \ \ \ :\ \textcolor{keyword}{public}\ bool\_constant<}
...
\DoxyCodeLine{00875\ \textcolor{keyword}{template}<\textcolor{keywordtype}{bool}>\ \textcolor{keyword}{struct\ }EnableIf;}
\DoxyCodeLine{00876\ \textcolor{keyword}{template}<>\ \textcolor{keyword}{struct\ }EnableIf<true>\ \{\ \textcolor{keyword}{typedef}\ \textcolor{keywordtype}{void}\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00877\ }
...
\DoxyCodeLine{00964\ \textcolor{keyword}{class\ }NativeArray\ \{}
